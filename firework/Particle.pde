class Particle {
  ...
  Particle() {
    ...
    part.vertex(+partSize/2, -partSize/2, smoke.width, 0);
    part.vertex(+partSize/2, +partSize/2, smoke.width, smoke.height);
    part.vertex(-partSize/2, +partSize/2, 0, smoke.height);
    part.endShape();
