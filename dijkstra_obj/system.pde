...
class System extends Renderable{
    ...
    System(PVector d, int obstacleCount){
        ...
        aiPiece = new Movable(new PVector(dimensions.x, dimensions.y, dimensions.z), defaultRadius);
        aiPiece.c = color(255, 0, 0);
        playerPiece = new Movable(new PVector(0, 0, 0), defaultRadius);
        playerPiece.c = color(0, 255, 0);
        
        objects.add(new Object(new PVector(dimensions.x/2, dimensions.y/2,dimensions.z/2), defaultRadius));
